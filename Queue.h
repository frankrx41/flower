...
typedef void (*CB_ProcessData_Void_Ptr32_Ptr32) (ptr32 data, ptr32 ptr);
typedef bool (*CB_CompareData_Bool_Ptr32_Ptr32) (ptr32 dat1, ptr32 dat2);
typedef void (*CB_DestroyData_Void_Ptr32)       (ptr32 data);
...
ptr32   Queue_RemoveFindFirst   (Queue* queue, CB_FindData_Bool_Ptr32_Ptr32 cb_find_data, ptr32 ptr);     // If cb_find_data is NULL, it will find the ptr
