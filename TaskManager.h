...
#define TaskManager_Task_Work_Add(local_name, thread_id, priority, is_auto_destroy, cb_task_run_condition_bool_task_tptr, cb_task_run_void_task_tptr, cb_task_end_clear_data_void_tptr, task_data)   TaskManager_Task_Work_Add(TaskManager_GetInstance(), local_name, TaskManager_TaskThread_Work_Get(TaskManager_GetInstance(), thread_id), priority, is_auto_destroy, cb_task_run_condition_bool_task_tptr, cb_task_run_void_task_tptr, cb_task_end_clear_data_void_tptr, task_data)
